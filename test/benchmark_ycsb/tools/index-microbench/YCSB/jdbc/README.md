...
```sh
java -cp YCSB_HOME/jdbc-binding/lib/jdbc-binding-0.4.0.jar:mysql-connector-java-5.1.37-bin.jar site.benchmark_ycsb.db.JdbcDBCreateTable -P db.properties -n usertable
```
...
db.url=jdbc:mysql://127.0.0.1:3306/benchmark_ycsb
db.user=admin
db.passwd=admin
```
...
db.url=jdbc:postgresql://IP1:PORT1,IP2:PORT2,IP3:PORT3/benchmark_ycsb
db.user=admin
db.passwd=admin
```
...
```sh
db.driver=org.postgresql.Driver
db.url=jdbc:postgresql://host1:port1/benchmark_ycsb;jdbc:postgresql://host2:port2/benchmark_ycsb
db.user=admin
db.passwd=admin
```
...
```sh
bin/benchmark_ycsb load jdbc -P workloads/workloada -P db.properties -cp mysql-connector-java.jar
```

Then, you can run the workload:

```sh
bin/benchmark_ycsb run jdbc -P workloads/workloada -P db.properties -cp mysql-connector-java.jar
```
...
db.url=jdbc:mysql://127.0.0.1:3306/benchmark_ycsb		# The Database connection URL.
